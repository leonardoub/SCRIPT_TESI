...
input_path = '/home/leonardo/Scrivania/data'
...
for patient in patient_list:
    ...
    MASK_path = f'{input_path}/{patient}/MASK_BRAIN_HANDMADE.nii'
    ...
    sitk.WriteImage(CTxMASK_stk, f'{input_path}/{patient}/CTxMASK_BRAIN_HANDMADE.nii', True)
