...
dataset_path = '/home/leonardo/Scrivania/TESI/tabelle/ADC/tab_outcome_C_bc_100_for_classification.csv' 

X=pd.read_csv(dataset_path)

X=X.drop(X.columns[np.arange(0,33)], axis=1)
X=X.drop(X.columns[np.arange(93,107)], axis=1) #servono per togliere le shape features
...
X1_train,X1_test,Y1_train,Y1_test=train_test_split(X1,Y1, train_size=23)
