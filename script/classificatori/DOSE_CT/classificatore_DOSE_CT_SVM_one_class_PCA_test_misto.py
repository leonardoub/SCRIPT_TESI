...
dataset_DOSE_path = '/home/leonardo/Scrivania/TESI/tabelle/tab_outcome_bW1_classificazione.csv' 
dataset_CT_path = '/home/leonardo/Scrivania/TESI/tabelle/CT/tab_outcome_CT_bW1_MOD2_classificazione.csv' 
...
def preprocess_CT(dataset_path):
    ...
    X_CT=X_CT.drop(X_CT.columns[np.arange(0,37)], axis=1)
...
def preprocess_pca(X, Y):
    ...
    X1_train, X1_test, Y1_train, Y1_test = train_test_split(X1, Y1, train_size=26, random_state=0)
...
X_CT, Y_CT = preprocess_CT(dataset_CT_path)
CT_X1_train_n_reduced, CT_Y1_train, CT_X_TEST_n_reduced, CT_Y_TEST = preprocess_pca(X_CT, Y_CT)


TOT_X1_train_n_reduced = np.concatenate((DOSE_X1_train_n_reduced, CT_X1_train_n_reduced), axis=1)
TOT_Y1_train = DOSE_Y1_train
TOT_X_TEST_n_reduced = np.concatenate((DOSE_X_TEST_n_reduced, CT_X_TEST_n_reduced), axis=1)
