...
my_dict_03 = {**new_dict_03, **dict_bvec_03}
...
my_dict_55 = {**new_dict_55, **dict_bvec_55}
...
K=pd.DataFrame.from_dict(D, orient='index', columns=interesting_keys+bvec_keys)
