...
os.chdir('/home/leonardo/Scrivania/TESI/features/features_CT_estratte_bW1_MOD2')
patient_list=os.listdir()

df_patient=[]

for patient in patient_list:
    df=pd.read_csv('/home/leonardo/Scrivania/TESI/features/features_CT_estratte_bW1_MOD2/'+patient)
...
#DOVREBBE ANDAR BENE
df3.to_csv(r'/home/leonardo/Scrivania/TESI/tabelle/CT/tab_outcome_CT_bW1_MOD2.csv', header=True)
