...
parameters={'kernel':('linear','rbf'), 'gamma':[0.001, 0.01, 0.1, 1], 'nu':[0.001, 0.01, 0.1, 1]}

OCC=OneClassSVM()

clf=GridSearchCV(OCC, parameters, scoring='f1', n_jobs=-1, return_train_score=True)
clf.fit(X1_train_n, Y1_train)
